...
class Ui_ProjectInfoDialog(object):
    def setupUi(self, ProjectInfoDialog):
        ...
        self.txt_project_teardown = QtWidgets.QPlainTextEdit(self.tab_4)
        self.txt_project_teardown.setObjectName("txt_project_teardown")
        self.horizontalLayout_4.addWidget(self.txt_project_teardown)
