...
class Ui_KeyValueWidget(object):
    def setupUi(self, KeyValueWidget):
        ...
        self.chk_field_enabled = QtWidgets.QCheckBox(parent=KeyValueWidget)
        ...
        self.txt_name = QtWidgets.QLineEdit(parent=KeyValueWidget)
        self.txt_name.setStyleSheet("")
        self.txt_name.setObjectName("txt_name")
        self.horizontalLayout.addWidget(self.txt_name)
        self.txt_value = CompletionLineEdit(parent=KeyValueWidget)
        self.txt_value.setObjectName("txt_value")
        self.horizontalLayout.addWidget(self.txt_value)
        self.btn_remove_header = QtWidgets.QToolButton(parent=KeyValueWidget)
