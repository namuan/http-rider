...
def gen_class_variable(var_name, var_type, is_array=False):
    ...
    if is_array:
        return f"List<{java_type}> {to_java_variable(var_name)};"
    return f"{java_type} {to_java_variable(var_name)};"
