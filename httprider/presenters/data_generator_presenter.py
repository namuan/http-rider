...
class DataGeneratorPresenter:
    ...
    def fake_to_form(self):
        ...
        self.view.lbl_eg_custom_string.setText("eg: {}".format(
        ...
        self.view.lbl_eg_person_prefix.setText("eg: {}".format(
            random_person(('prefix', gender))
        ))
        self.view.lbl_eg_person_first_name.setText("eg: {}".format(
            random_person(('first_name', gender))
        ))
        self.view.lbl_eg_person_last_name.setText("eg: {}".format(
            random_person(('last_name', gender))
        ))
        self.view.lbl_eg_person_full_name.setText("eg: {}".format(
            random_person(('full_name', gender))
        ))
        self.view.lbl_eg_person_suffix.setText("eg: {}".format(
            random_person(('suffix', gender))
        ))

        # Address section

        self.view.lbl_eg_address_country.setText("eg: {}".format(
            random_address('country')
        ))
        self.view.lbl_eg_address_full.setText("eg: {}...".format(
            random_address('address')[:15]
        ))
        self.view.lbl_eg_address_secondary.setText("eg: {}".format(
            random_address('secondary')
        ))
        self.view.lbl_eg_address_street.setText("eg: {}".format(
            random_address('street')
        ))
        self.view.lbl_eg_address_city.setText("eg: {}".format(
            random_address('city')
        ))
        self.view.lbl_eg_address_zipcode.setText("eg: {}".format(
            random_address('zipcode')
        ))
        self.view.lbl_eg_address_state.setText("eg: {}".format(
