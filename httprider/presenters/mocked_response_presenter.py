...
class MockedResponsePresenter:
    ...
    def refresh_completer(self):
        ...
        self.parent_view.txt_mocked_response_body.child_edit.setup_completer(
            completer_model
        )
    ...
    def form_to_object(self):
        ...
        mocked_response.is_enabled = (
            self.parent_view.chk_mock_response_enabled.isChecked()
        )
        mocked_response.status_code = str_to_int(
            self.parent_view.txt_mocked_response_code.text()
        )
